...
public class UserAuthServlet extends HttpServlet {
  ...
  private static final String SOFTWARE_ENGINEERING_REDIRECT = "/softwareEngineering.html";
  ...
  private static String loginUrl = userService.createLoginURL(SOFTWARE_ENGINEERING_REDIRECT);
