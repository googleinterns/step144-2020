...
public class RandomEvent {
   ...
   *
   * @param willRedirect A boolean representing whether or not the player's game stage will be
   *     changed
   */
   ...
   *
   * @param redirectStageID A string representing the datastore id of the game stage the player is
   *     moved to.
   */
